...
public class OrderItemAsserts {
    ...
    public static void assertOrderItemUpdatableFieldsEquals(OrderItem expected, OrderItem actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getMovieId()).as("check movieId").isEqualTo(expected.getMovieId()))
            .satisfies(a -> assertThat(a.getMovieTitle()).as("check movieTitle").isEqualTo(expected.getMovieTitle()))
